...
GITHUB_REPO=git@github.com/hongzhangfa/hongzhangfa.github.io.git
# GITHUB_REPO=git@github.com/xingcxb/symbol_blog.git

comment=$1

if [ ! $comment ]; then
comment="update something + Action auto-deploy"
fi
